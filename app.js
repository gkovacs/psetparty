...
(function() {
  var $, app, buildingaddress, buildingdata, buildingname, classdata, classes, classlist, classlist_set, dumpToDisk, everyone, express, fs, getCalendarId, getClasses, getEvents, getEventsForUser, http, httpserver, iced, line, location_addresses, location_list, nowjs, parseEvent, rclient, redis, request, restler, subjectnum, __iced_k, __iced_k_noop, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3;
  ...
  _ref = JSON.parse(fs.readFileSync('psetparty.json', 'utf-8')), classes = _ref.cl, everyone.now.events = _ref.ev;
  ...
  */
  ...
  getEvents = everyone.now.getEvents = function(title, callback) {
    ...
    */
    if (!(everyone.now.events[title] != null)) everyone.now.events[title] = {};
    return callback(everyone.now.events[title]);
  };
