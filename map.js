...
function calendarEntered() {
  ...
  $('#addToGoogleCalendarLink').attr('href', encodeURI('http://www.google.com/calendar/render?cid=http://psetparty.xvm.mit.edu:3333/exportcal?username=' + email + '&k=' + Math.floor(Math.random()*100000)))
}
